...
public class PdfDocument {
    ...
    /**
     * Starts a page using the provided {@link android.support.graphics.pdf.PdfDocument.PageInfo}. After the page
     * is created you can draw arbitrary content on the page's canvas which
     * you can get by calling {@link android.support.graphics.pdf.PdfDocument.Page#getCanvas()}. After you are done
     * drawing the content you should finish the page by calling
     * {@link #finishPage(android.support.graphics.pdf.PdfDocument.Page)}. After the page is finished you should
     * no longer access the page or its canvas.
     * <p>
     * <strong>Note:</strong> Do not call this method after {@link #close()}.
     * Also do not call this method if the last page returned by this method
     * is not finished by calling {@link #finishPage(android.support.graphics.pdf.PdfDocument.Page)}.
     * </p>
     *
     * @param pageInfo The page info. Cannot be null.
     * @return A blank page.
     *
     * @see #finishPage(android.support.graphics.pdf.PdfDocument.Page)
     */
     ...
     *
     * @see #startPage(android.support.graphics.pdf.PdfDocument.PageInfo)
     */
     ...
     * android.support.graphics.pdf.PdfDocument.PageInfo)} is not finished by calling {@link #finishPage(android.support.graphics.pdf.PdfDocument.Page)}.
     * </p>
     *
     ...
     * returned by {@link #startPage(android.support.graphics.pdf.PdfDocument.PageInfo)} is not finished by
     * calling {@link #finishPage(android.support.graphics.pdf.PdfDocument.Page)}.
     * </p>
     */
    public void close() {
        throwIfCurrentPageNotFinished();
    ...
    /**
     * This class represents meta-data that describes a PDF {@link android.support.graphics.pdf.PdfDocument.Page}.
     */
    public static final class PageInfo {
        ...
        /**
         * Builder for creating a {@link android.support.graphics.pdf.PdfDocument.PageInfo}.
         */
        public static final class Builder {
            ...
            /**
             * Creates a new {@link android.support.graphics.pdf.PdfDocument.PageInfo}.
             *
     ...
     * {@link android.support.graphics.pdf.PdfDocument.PageInfo} instance that describes its attributes. Also
     * a page has 
     */
    public static final class Page {
        ...
        /**
         * Gets the {@link android.graphics.Canvas} of the page.
         *
         * <p>
         ...
         * <ul>
         * <li>Inverse path clipping performed via {@link android.graphics.Canvas#clipPath(android.graphics.Path,
         ...
         * <li>{@link android.graphics.Canvas#drawVertices(android.graphics.Canvas.VertexMode, int,
         ...
         * <li>Color filters set via {@link android.graphics.Paint#setColorFilter(
         *     android.graphics.ColorFilter)}</li>
         * <li>Mask filters set via {@link android.graphics.Paint#setMaskFilter(
         ...
         *
         * @see android.support.graphics.pdf.PdfDocument#finishPage(android.support.graphics.pdf.PdfDocument.Page)
         */
        ...
        /**
         * Gets the {@link android.support.graphics.pdf.PdfDocument.PageInfo} with meta-data for the page.
         *
